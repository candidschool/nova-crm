...
const HotLeads = ({ onLogout, user }) => {
  ...
  const getStageCount = (stageName) => {
    ...
    return leadsData.filter(lead => {
      ...
      const isHotLead = lead.category === 'Hot';
      return isHotLead && (leadStageKey === stageKey || lead.stage === stageName);
    }).length;
  };
  ...
  const getDisplayLeads = () => {
    let filtered = leadsData.filter(lead => lead.category === 'Hot');
        ...
        <div className="nova-header">
          <div className="header-left">
            ...
            <span className="total-count">
              Total Hot Leads {allFilteredLeads.length}
            </span>
                ...
                <tr>
                  <td colSpan="9" className="no-data">
                    {searchTerm 
                      ...
                      : 'No hot leads available. Hot leads will appear here when their status changes to "Hot".'}
                  </td>
                </tr>
              )}
            </tbody>
